...
public class Pojo_deserialize {
    ...
    public void oneSpartanPojo(){
        ...
        //JSON to POJO --> de seralize to JAVA Custom sclass
    ...
    public void regionToPojo(){
        ...
        Response response = when().get("http://3.87.241.127:1000/ords/hr/regions");
    ...
    public void gson_example(){
        ...
        Spartan spartanEU = new Spartan(200, "Mike", "Male", 123311222);
